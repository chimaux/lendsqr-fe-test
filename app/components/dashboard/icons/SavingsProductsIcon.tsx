...
const SavingsProductsIcon: React.FC<IconProps> = ({ className }) => {
  return (
    <svg
      width="20"
      height="20"
...
export default SavingsProductsIcon;
